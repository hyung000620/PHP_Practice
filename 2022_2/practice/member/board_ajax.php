...
<div class='wrap'>
    ...
    <div>
        ...
        <div class='paging' style="text-align:center; margin-top:30px;">
            ...
            <div class='paging_navi' style="margin:0 6px; width: auto; line-height:0; display:inline-block;"><!-- 페이징 --><?=$html?></div>
...
function srchKeyword()
{
    $.ajax({
        type: "POST",
        url: "/sam_board/_board_50_res.php",
        ...
        success: function(data){
            ...
            else
            {
                ...
                {
                    arr_page.push("<span class='page' ");
                    arr_page.push("style='border:1px solid #cccccc; width: 30px; height:30px; line-height:28px; font-size:12px; display:inline-block;' >");
                    arr_page.push(i);
                    arr_page.push("</span>");
                }
            }
...
function frmView(idx)
{
    ...
    $.ajax(
    {
        ...
        success: function(data)
        {
            ...
            {
                arr_list.push("<div style='text-align:center; height:800px;'>");
                arr_list.push("<div class='right'><img style='cursor:pointer; width: 60px;' onclick='naver_share()'");
...
{
    let page = 1;
    $('.paging_navi span').each(function(){
        let text = $(this).text();
        console.log(text);
    });
